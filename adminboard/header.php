        ...
        <ul class="nav navbar-right top-nav">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu message-dropdown">
                        ...
                        <a href="#">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="small text-muted"><i class="fa fa-clock-o"></i> Čas prejetja</p>
                                    <p>Sporočilo</p>
                                </div>
                            </div>
                        </a>
                    ...
                    <li class="message-footer">
                        <a href="#">Preglej vsa sporočila</a>
                    </li>
                </ul>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-fw fa-envelope"></i> Moji članki</a>
                    </li>
                    <li>
                    ...
                    <li class="divider"></li>
                    <li>
                        <a href="#"><i class="fa fa-fw fa-power-off"></i> Izpis</a>
                    </li>
                </ul>
            </li>
        </ul>
