                    ...
                    <td>
                        <?php if($resultRows['status']=="Active" ){ ?>
                            <div class="material-switch pull-left">
                                <input id="<?php echo $resultRows['id'];  ?>" name="<?php echo $resultRows['ime'];  ?>" onclick="changeStatus(this.id)" type="checkbox" checked="checked" />
                                <label for="<?php echo $resultRows['id'];  ?>" class="label-success"></label>
                            </div>
                            <?php }
                            else if($resultRows['status']=="notActive"){ ?>
                                <div class="material-switch pull-left">
                                    <input id="<?php echo $resultRows['id'];  ?>" name="<?php echo $resultRows['ime'];  ?>" onclick="changeStatus(this.id)" type="checkbox"  />
                                    <label for="<?php echo $resultRows['id'];  ?>" class="label-success"></label>
                                </div>
                            <?php } ?>
                    </td>
